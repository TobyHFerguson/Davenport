...
The use of Oracle Enterprise Manager is explained in detail in  [[docs/Bare_Metal_Provisioning_With_Oracle_Enterprise_Manager.org][Bare Metal Provisioning with Oracle Enterprise Manager]]
* Setup
