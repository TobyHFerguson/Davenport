...
This process takes of the order of 2 to 3 hours (with the bulk of that time being the OMS installation). During this time you should do two things:
+ Prepare a test machine, described below
+ Read the 'Bare Metal Provisioning with Oracle Enterprise Manager' document to learn how to use this system.
